...
<nav class="menu">
   ...
   <a href="admin/tasks" class="menu-item green"> agenda </a>
   <a href="#" class="menu-item red"> vorderingen </a>
   @if(Auth::user()->admin == "0")
   <a href="#" class="menu-item purple btn btn-primary" data-toggle="modal" data-target="#exampleModal"> info </a>
   @else
   <a href="#" class="menu-item purple btn btn-primary"> info </a>
   @endif
   <a href="#" class="menu-item orange"> leerstrategien </a>
   <a href="https://talnet-student.educus.nl/?1U" class="menu-item lightblue"> Eduarte </a>
</nav>
   ...
   <div class="modal-dialog" role="document">
     <div class="modal-content">
       <div class="modal-header">
         <h5 class="modal-title" style="color:black" id="exampleModalLabel">Mijn Pluscoach</h5>
         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
           <span aria-hidden="true">&times;</span>
         </button>
       </div>
       <div class="modal-body">
         <p style="color: black;">Naam: {{@Auth::user()->pluscoach->name}}</p>
         <p style="color: black;">Email: {{@Auth::user()->pluscoach->email}}</p>
         
         <p style="color: black;">Telefoonnummer: {{@Auth::user()->pluscoach->telefoon}}</p>
       </div>
...
{{-- <script>
    $(document).ready(function() {
        ...
        $('#calendar').fullCalendar({
            ...
            <script
                src="https://cloud.tinymce.com/5/tinymce.min.js?apiKey=8l7l9d7cvses1xqg3ty351cuwlc2d1gxzoe4ovcz7j5e39jn">4</script>
            <script>
                tinymce.init({
                    selector: 'textarea',
